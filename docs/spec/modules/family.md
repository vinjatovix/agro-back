...
- **Polymorphic idOrSlug Lookup:**
  ...
  - **Mutation Operations `[TARGET STATE (Pending [Iteration 32](../../roadmap.md#iteration-32-implement-deletefamily-and-enable-polymorphic-lookups-for-family-mutations))]`:** Supporting polymorphic lookup (`idOrSlug`) on mutating endpoints (`PATCH`, `DELETE`) is strictly pending [Iteration 32](../../roadmap.md#iteration-32-implement-deletefamily-and-enable-polymorphic-lookups-for-family-mutations).
