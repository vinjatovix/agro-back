...
- POST /api/v1/plants (implemented for `admin`, `collaborator` role is `[TARGET STATE (Pending [Iteration 31](../../roadmap.md#iteration-31-introduce-collaborator-role-in-auth-middleware))]`)

_(Note: In Phase 2 - Social Catalog, we introduce the collaborator role)_

- GET /api/v1/plants (public)
- GET /api/v1/plants/:id (public)
- PATCH /api/v1/plants/:id (implemented for `admin`, `collaborator` role is `[TARGET STATE (Pending [Iteration 31](../../roadmap.md#iteration-31-introduce-collaborator-role-in-auth-middleware))]`)
- DELETE /api/v1/plants/:id (implemented for `admin`, `collaborator` role is `[TARGET STATE (Pending [Iteration 31](../../roadmap.md#iteration-31-introduce-collaborator-role-in-auth-middleware))]`)
...
#### Optional Sowing Schema Alignment `[TARGET STATE (Pending [Iteration 35](../../roadmap.md#iteration-35-make-plant-sowing-block-optional))]`

When implementing **[Iteration 35](../../roadmap.md#iteration-35-make-plant-sowing-block-optional) (Sowing Validation Refinement)**, the developer MUST update the external API contract inside `@src/apps/agroApi/openapi/openapi.yaml`:
...
- POST /api/v1/beds/:id/layout/validate `[TARGET STATE (Pending [Iteration 66](../../roadmap.md#iteration-66-implement-stateless-layout-simulation-endpoint))]`
- PUT /api/v1/beds/:id/layout `[TARGET STATE (Pending [Iteration 67](../../roadmap.md#iteration-67-implement-transactional-batch-save-layout-endpoint))]`
...
### 6.4 PlantInstances (user) `[TARGET STATE (Pending Iterations [20](../../roadmap.md#iteration-20-extract-plantinstance-into-standalone-collection) & [56](../../roadmap.md#iteration-56-build-2d-euclidean-proximity-calculator))]`
...
- POST /api/v1/plant-instances/:id/transplant `[TARGET STATE (Pending [Iteration 75](../../roadmap.md#iteration-75-implement-transplant-api-with-spatial-validation))]`
...
### 6.6 Events (user) `[TARGET STATE (Pending Iterations [70](../../roadmap.md#iteration-70-implement-append-only-cultivationlog-aggregate-with-scopes) & [72](../../roadmap.md#iteration-72-expose-cultivationlog-crud-endpoints))]`

- event ingestion API
- filtering by plantInstance / bed / type

#### Endpoints `[TARGET STATE (Pending [Iteration 72](../../roadmap.md#iteration-72-expose-cultivationlog-crud-endpoints))]`
...
### 6.7 Knowledge `[TARGET STATE (Pending Iterations [39](../../roadmap.md#iteration-39-implement-anomaly-domain-and-crud-endpoints) & [40](../../roadmap.md#iteration-40-implement-gardeninput-domain-and-crud-endpoints))]`
...
### 6.8 Plant Relations `[TARGET STATE (Pending [Iteration 37](../../roadmap.md#iteration-37-implement-plantrelation-aggregate-and-repository))]`
...
### 6.9 Seed Bank (user) `[TARGET STATE (Pending [Iteration 52](../../roadmap.md#iteration-52-implement-seedbatch-aggregate-and-repository))]`
