...
- **`[TARGET STATE (Pending [Iteration 20](../../roadmap.md#iteration-20-extract-plantinstance-into-standalone-collection))]` Standalone collection:** PlantInstances are fully detached from the Bed aggregate and persisted in their own independent `plant_instances` collection. They are loaded dynamically using the `PlantInstanceRepository` (two queries are made to draw/render the Bed map).
...
## 5. SPATIAL MODEL `[TARGET STATE (Pending Iterations [56](../../roadmap.md#iteration-56-build-2d-euclidean-proximity-calculator) & [58](../../roadmap.md#iteration-58-implement-container-volumetric-capacity-validation))]`

### 5.1 Hybrid Bed Types `[TARGET STATE (Pending Iterations [56](../../roadmap.md#iteration-56-build-2d-euclidean-proximity-calculator) & [58](../../roadmap.md#iteration-58-implement-container-volumetric-capacity-validation))]`
...
### 5.2 Volumetric & Geometric Properties `[TARGET STATE (Pending Iterations [56](../../roadmap.md#iteration-56-build-2d-euclidean-proximity-calculator) & [58](../../roadmap.md#iteration-58-implement-container-volumetric-capacity-validation))]`
...
### 5.3 Soil, Mulch, & Microclimate Properties `[TARGET STATE (Pending [Iteration 61](../../roadmap.md#iteration-61-add-shadezones-to-bed-aggregate))]`
...
### 7.3 Bed Resizing Boundary Constraint `[TARGET STATE (Pending [Iteration 65](../../roadmap.md#iteration-65-block-bed-resizing-if-active-crops-overflow-boundaries))]`
...
### 9.4 `[TARGET STATE (Pending [Iteration 73](../../roadmap.md#iteration-73-implement-nested-soil-analysis-log-on-bed))]` Soil Analysis & Amendments History
