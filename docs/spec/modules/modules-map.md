...
### 3.4 Cultivation logs

```sh
/modules/cultivation-logs.md
```
...
### 3.10 Plant Instance System `[TARGET STATE (Pending [Iteration 20](../../roadmap.md#iteration-20-extract-plantinstance-into-standalone-collection))]`
...
- no event logic
- no knowledge logic
- **`[TARGET STATE (Pending [Iteration 20](../../roadmap.md#iteration-20-extract-plantinstance-into-standalone-collection))]`** completely decoupled from individual plant aggregates (not responsible for saving or retrieving plant instances)
...
### 3.16 Seed Bank System `[TARGET STATE (Pending [Iteration 52](../../roadmap.md#iteration-52-implement-seedbatch-aggregate-and-repository))]`
...
- **`[TARGET STATE (Pending [Iteration 52](../../roadmap.md#iteration-52-implement-seedbatch-aggregate-and-repository))]`** scoped to a single authenticated User
...
### 3.18 Reminders System `[TARGET STATE (Pending Iterations [79](../../roadmap.md#iteration-79-implement-stateful-reminder-aggregate-and-crud) & [85](../../roadmap.md#iteration-85-delay-irrigation-reminders-based-on-precipitation))]`
...
### 3.19 Plant Relations System `[TARGET STATE (Pending [Iteration 37](../../roadmap.md#iteration-37-implement-plantrelation-aggregate-and-repository))]`
...
### 3.20 Observability & Telemetry Pipeline `[TARGET STATE (Pending Iterations [48](../../roadmap.md#iteration-48-implement-mongodb-change-stream-tailer-for-outbox) & [43](../../roadmap.md#iteration-43-implement-winston-kafka-transport))]`
...
### 3.21 Distributed Event Bus (Kafka) `[TARGET STATE (Pending Iterations [47](../../roadmap.md#iteration-47-write-domain-events-to-outbox-within-transactions), [48](../../roadmap.md#iteration-48-implement-mongodb-change-stream-tailer-for-outbox) & [50](../../roadmap.md#iteration-50-implement-consumer-idempotence-with-ttl-store))]`
...
Auth → Domain (references User, Email, UserId)
Reminders → Domain (references User, UserId)
