...
### 5.1.1 Geometric 2D Collision (Ground/Raised Beds) `[TARGET STATE (Pending [Iteration 56](../../roadmap.md#iteration-56-build-2d-euclidean-proximity-calculator))]`
...
### 5.1.2 Volumetric Collision & Soil Constraint (Containers) `[TARGET STATE (Pending [Iteration 58](../../roadmap.md#iteration-58-implement-container-volumetric-capacity-validation))]`
...
### 5.1.3 Square Foot Gardening (SFG) Grid Conversion & Snapping `[TARGET STATE (Pending [Iteration 57](../../roadmap.md#iteration-57-implement-sfg-30cm-virtual-grid-snapping))]`
...
## 5.2 Distance & Companionship Analysis (ecologicalReport) `[TARGET STATE (Pending [Iteration 60](../../roadmap.md#iteration-60-generate-advisory-warnings-for-spatial-overlaps))]`
...
## 5.3 Crop Rotation Advisory Heuristic `[TARGET STATE (Pending Iterations [77](../../roadmap.md#iteration-77-compute-36-month-family-occupancy-via-db-aggregation) & [78](../../roadmap.md#iteration-78-generate-advisory-warnings-for-soil-depletion))]`
...
## 5.4 Microclimate & Sun Exposure Validation `[TARGET STATE (Pending Iterations [61](../../roadmap.md#iteration-61-add-shadezones-to-bed-aggregate) & [62](../../roadmap.md#iteration-62-validate-localized-sun-exposure-against-plant-preferences))]`
...
## 5.5 Exclusion of Terminated Instances & Temporal Space Liberation (Time-Travel) `[TARGET STATE (Pending Iterations [22](../../roadmap.md#iteration-22-standardize-soft-deletion-on-bed-and-plantinstance) & [56](../../roadmap.md#iteration-56-build-2d-euclidean-proximity-calculator))]`
...
### 5.7.1 Dry-Run Layout Simulation (Stateless Verification) `[TARGET STATE (Pending [Iteration 66](../../roadmap.md#iteration-66-implement-stateless-layout-simulation-endpoint))]`
...
### 5.7.2 Consolidated Layout Saving (Batch Persistence & Planning Modes) `[TARGET STATE (Pending Iterations [67](../../roadmap.md#iteration-67-implement-transactional-batch-save-layout-endpoint) & [68](../../roadmap.md#iteration-68-persist-pre-computed-ecological-reports-on-bed))]`
...
- **Mode: Execution (`linkToSeedBank: true`):** The backend performs a **synchronous, read-only validation** against the SeedBank inventory. If the required quantities exceed the user's active stock, the system does not fail-fast or abort the entire transaction. Instead, it automatically switches those specific out-of-stock placements to Planning Mode (by setting `linkToSeedBank` to `false` for those items), allows other valid placements with sufficient stock to deduct stock asynchronously, and includes a warning (specifying the affected placement IDs and details in a structured `warnings` array inside the standard JSON response body).
- **Backend Execution:** The backend clears previous active instances inside the Bed, runs a final synchronous validation of the whole layout (including the non-blocking stock check and auto-conversion if in Execution Mode), and persists the new crop coordinates in a single database transaction (`ClientSession`).
...
- Container volumetric & capacity collision rules `[TARGET STATE (Pending [Iteration 58](../../roadmap.md#iteration-58-implement-container-volumetric-capacity-validation))]`
- Sun exposure microclimate matching `[TARGET STATE (Pending [Iteration 62](../../roadmap.md#iteration-62-validate-localized-sun-exposure-against-plant-preferences))]`
- PlantRelation companions graph proximity queries (`ecologicalReport`) `[TARGET STATE (Pending Iterations [37](../../roadmap.md#iteration-37-implement-plantrelation-aggregate-and-repository), [56](../../roadmap.md#iteration-56-build-2d-euclidean-proximity-calculator) & [64](../../roadmap.md#iteration-64-scale-down-advisory-spacing-for-beneficial-companions))]`
- 36-month Crop rotation event analytics `[TARGET STATE (Pending [Iteration 77](../../roadmap.md#iteration-77-compute-36-month-family-occupancy-via-db-aggregation))]`
- Temporal time-travel space liberation logic `[TARGET STATE (Pending Iterations [22](../../roadmap.md#iteration-22-standardize-soft-deletion-on-bed-and-plantinstance) & [56](../../roadmap.md#iteration-56-build-2d-euclidean-proximity-calculator))]`
- **`[TARGET STATE (Pending [Iteration 63](../../roadmap.md#iteration-63-bypass-2d-collisions-for-complementary-vertical-strata))]` Vertical Canopy Strata & Guild Layering:**
...
- **`[TARGET STATE (Pending [Iteration 64](../../roadmap.md#iteration-64-scale-down-advisory-spacing-for-beneficial-companions))]` Dynamic Companion Proximity Scaling:**
