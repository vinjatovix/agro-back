...
## 7. ACCESS CONTROL & ROLE SECURITY `[TARGET STATE (Pending Iterations [31](../../roadmap.md#iteration-31-introduce-collaborator-role-in-auth-middleware) & [38](../../roadmap.md#iteration-38-expose-plantrelation-crud-endpoints))]`
...
### Pending `[TARGET STATE (Pending [Iteration 37](../../roadmap.md#iteration-37-implement-plantrelation-aggregate-and-repository))]`
